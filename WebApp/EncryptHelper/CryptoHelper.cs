...
namespace WebApp.EncryptHelper
{
  /*  public class CryptoHelper
    {
        ...
        public static string ComputedHash(string plainText, Supported_HA hash, byte[] salt) { 
        ...
        public static bool Confirm(string plainText, string hashValue, Supported_HA hash) {
            ...
            string newHash = ComputedHash(plainText, hash, saltBytes);
