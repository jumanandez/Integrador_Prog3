...
namespace WinForm
{
	public partial class FormProducto : Form
	{
		...
		public List<Producto> ProductosConCategorias(List<Producto> productos, List<Categoria> categorias)
		{
		...
		private void RefreshGrid()
		{
			...
			dataGridViewProducto.DataSource = ProductosConCategorias(_productoBusiness.GetAll(), _categoríaBusiness.GetAll());
		}
		...
		private void textBox1_TextChanged(object sender, EventArgs e)
		{
			...
			dataGridViewProducto.DataSource = ProductosConCategorias(filteredProductos.ToList(),
																	_categoríaBusiness.GetAll());
